...
namespace Tyr::Gui
{
void Renderer::draw(const Common::RefereeState &t_referee_state, const Common::FieldState &t_field)
{
    ...
    auto ref_state = "Ref: " + t_referee_state.getString();
    auto textSize  = MeasureTextEx(m_font, ref_state.c_str(), 400, 0).x;
