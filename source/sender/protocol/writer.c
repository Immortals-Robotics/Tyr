...
{
    const uint8_t bits_data = data->bit0 | data->bit1 << 1 | data->bit2 << 2 | data->bit3 << 3 | data->bit4 << 4 |
                              data->bit5 << 5 | data->bit6 << 6 | data->bit7 << 7;
...
{
    const uint16_t bits_data = data->bit0 | data->bit1 << 1 | data->bit2 << 2 | data->bit3 << 3 | data->bit4 << 4 |
                               data->bit5 << 5 | data->bit6 << 6 | data->bit7 << 7 | data->bit8 << 8 | data->bit9 << 9 |
                               data->bit10 << 10 | data->bit11 << 11 | data->bit12 << 12 | data->bit13 << 13 |
                               data->bit14 << 14 | data->bit15 << 15;
...
void write_bits32(uint8_t *const buffer, size_t *const pos, const struct bits32_t *const data)
{
    const uint32_t bits_data =
        data->bit0 | data->bit1 << 1 | data->bit2 << 2 | data->bit3 << 3 | data->bit4 << 4 | data->bit5 << 5 |
        data->bit6 << 6 | data->bit7 << 7 | data->bit8 << 8 | data->bit9 << 9 | data->bit10 << 10 | data->bit11 << 11 |
        data->bit12 << 12 | data->bit13 << 13 | data->bit14 << 14 | data->bit15 << 15 | data->bit16 << 16 |
        data->bit17 << 17 | data->bit18 << 18 | data->bit19 << 19 | data->bit20 << 20 | data->bit21 << 21 |
        data->bit22 << 22 | data->bit23 << 23 | data->bit24 << 24 | data->bit25 << 25 | data->bit26 << 26 |
        data->bit27 << 27 | data->bit28 << 28 | data->bit29 << 29 | data->bit30 << 30 | data->bit31 << 31;
...
void write_uint32(uint8_t *const buffer, size_t *const pos, const uint32_t data)
{
    ...
    buffer[*pos + 1] = (uint8_t) ((data & 0x0000FF00) >> 8);
    buffer[*pos + 2] = (uint8_t) ((data & 0x00FF0000) >> 16);
...
size_t write_robot_command_fixed(uint8_t *const buffer, const struct RobotCommand *const data)
{
    ...
    const uint8_t packed_data = ((uint8_t) data->shoot_type) | ((uint8_t) data->feedback) << 1 | (data->halt << 3) |
...
size_t write_robot_command_fixed_V2(uint8_t *const buffer, const struct RobotCommand_V2 *const data)
{
    ...
    const uint8_t packed_data =
        (0x00) | ((uint8_t) data->feedback_request) << 1 | (data->halt << 3) | (data->has_orientation << 4);
    ;
...
size_t write_robot_feedback_fixed(uint8_t *const buffer, const struct RobotFeedback *const data)
{
    ...
    const uint8_t packed_data =
        data->fault | data->ball_detected << 1 | data->booster_enabled << 2 | data->dribbler_connected << 3;
