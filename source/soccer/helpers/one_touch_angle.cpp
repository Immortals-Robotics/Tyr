...
{
Common::Angle Ai::calculateOneTouchAngle(const Robot& t_robot, const Common::Vec2 t_one_touch_position)
{
    ...
    OpenAngle boz = calculateOpenAngleToGoal(t_one_touch_position, t_robot);
