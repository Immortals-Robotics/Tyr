...
OpenAngle OpenAngle::calculateOpenAngleToGoal(const Common::Vec2 t_pos, const Robot& t_robot)
{
    ...
    const Common::Vec2 t2      = Field::oppGoalPostTop() + (MidGoal - Field::oppGoalPostTop()).normalized() * 25.0f;
    const Common::Vec2 t1      = Field::oppGoalPostBottom() + (MidGoal - Field::oppGoalPostBottom()).normalized() * 25.0f;
