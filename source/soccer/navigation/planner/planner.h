...
private:
    ...
    {
        const float margin_x = Common::field().boundary_width - Common::field().robot_radius;
        const float margin_y = Common::field().goal_boundary_width - Common::field().robot_radius;
